...
export const register = (app: Application) => {
  ...
  app.service(registerPath).hooks({
    ...
    before: {
      ...
      get: [],
      create: [
        schemaHooks.validateData(registerDataValidator),
        schemaHooks.resolveData(registerDataResolver)
      ],
      patch: [
        schemaHooks.validateData(registerPatchValidator),
        schemaHooks.resolveData(registerPatchResolver)
      ],
      remove: []
    },
    after: {
