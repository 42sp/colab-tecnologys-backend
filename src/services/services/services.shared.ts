...
import type { Services, ServicesData, ServicesPatch, ServicesQuery, ServicesService } from './services.class'
...
export const servicesMethods: Array<keyof ServicesService> = ['find', 'get', 'create', 'patch', 'remove']
