...
> {
		async find(params?: unknown): Promise<any> {
			...
			// 		) as changes
			// `, [
			// 	lastPulledAt / 1000, lastPulledAt / 1000, lastPulledAt / 1000, lastPulledAt / 1000, // services
			// 	lastPulledAt / 1000, lastPulledAt / 1000, lastPulledAt / 1000 // parameters
			// ]);
			...
			// 	) as changes
			// `, [
			// 	lastPulledAt / 1000, lastPulledAt / 1000, lastPulledAt / 1000, lastPulledAt / 1000 // para parameters
			// ]);
